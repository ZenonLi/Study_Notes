...
![](Linux C高级编程.assets/17.png)



2.若用于同步操作,往往会设置多个信号量,并且安排不同的初始值,来实现它们之间的执行顺序.

![](Linux C高级编程.assets/18.png)
...
![](Linux C高级编程.assets/29.png)

### **5.3 四次挥手**

![](Linux C高级编程.assets/30.png)
